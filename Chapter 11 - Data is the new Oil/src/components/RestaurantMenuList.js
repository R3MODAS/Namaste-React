                ...
                <div key={item.card.info.id} className='items'>
                    <div className='flex justify-between p-4'>
                        ...
                        <div className='relative w-[118px] h-[96px]'>
                            ...
                            <button className='font-ProximaNovaMed shadow-lg bg-white w-16 h-8 text-sm rounded left-1/2 -translate-x-1/2 absolute bottom-0 flex items-center justify-center'>Add</button>
                        </div>
