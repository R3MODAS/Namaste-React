        ...
        <>
          <section id='restaurants'>
            ...
            <div className="filter-btns flex gap-3" onClick={handleActive}>
              <button className='filter-btn font-GrotMed text-color-3 text-sm tracking-tight'>
                Fast Delivery
                <span className='text-lg ml-1 mb-[2px] hidden' onClick={() => window.location.reload()}>
                  <IoClose />
                </span>
              </button>
              <button onClick={handleRating} className='filter-btn font-GrotMed text-color-3 text-sm tracking-tight'>
                Rating 4.0+
                <span className='text-lg ml-1 mb-[2px] hidden' onClick={() => window.location.reload()}>
                  <IoClose />
                </span>
