...
import { IMG_CAROUSEL, RESTAURANT_API, TOP_CHAIN } from '../utils/constants'
    ...
    <div className="container mx-auto mt-24">
      {
        ...
        <>
          <section className="img-carousel-section relative">
...

      {
        TopChains.length != 0 &&
        <>
          <section className='top-chain-section relative'>
